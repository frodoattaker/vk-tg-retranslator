...
class VK
{
    ...
    private $token = 'vk1.a.g41fEOgUkUQlSqQm3_L3HyXuCkzPrc6oVXbvpYvdMeqYMEUwEtKW_1FCLULEsm0cftKLUoaoWouljB96hdQ0mQCD7HcL-vCPorc8Sw8pS0-T-Jk6hSc9O3juk9KEjfV-3iWdUv6jN0ruU8c3pL-1J-7eIlmU1SNZ2Y5FCwlDUXE7gSoLm8UgrzWvRMPKbbWopkeZZWmthoWm5R1kUUeiMw'; // Клютч доступа из ВКонтакте
    private $key = '7e3f5dd6';  // Строка, которую должен вернуть сервер
    public $data = '';
